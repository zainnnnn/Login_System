...
def signup(request):
    ...
    if request.method == "POST":
        ...
        if User.objects.filter(username=username):
            messages.error(
                request, "Username already exist! Please try another name")
        ...
        myuser.save()
        messages.success(
            request, "Your account has been successfully created. We have sent you a confirmation email, please confirm it to activite your account.")

        # welcome Email
        subject = "Welcome to our app - login confirmation"
        ...
        email_subject = "Confirm your email@fantastic.com"
